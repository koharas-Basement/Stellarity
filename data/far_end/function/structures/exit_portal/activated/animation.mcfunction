...
execute as @e[type=marker,tag=stellarity.dragon_marker] at @s run function stellarity:mob/dragon/death/loop_as_marker

# - death delay
execute if score @s stellarity.dragon.respawn_animation_progress matches 180 run function stellarity:mob/dragon/death/finish
