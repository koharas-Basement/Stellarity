...
item modify entity @s armor.feet kohara:append_durability_lore
execute if score $player.out_0 kohara.misc matches -1..0 run playsound minecraft:entity.item.break player @a[distance=..16]
execute if score $player.out_0 kohara.misc matches -1..0 run item replace entity @s armor.feet with minecraft:air
