...
item modify entity @s armor.head kohara:append_durability_lore
...
execute if score $player.out_0 kohara.misc matches -1..0 run item replace entity @s armor.head with minecraft:air
