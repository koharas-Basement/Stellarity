...
item modify entity @s weapon.mainhand kohara:append_durability_lore
...
execute if score $player.out_0 kohara.misc matches -1..0 run item replace entity @s weapon.mainhand with minecraft:air
