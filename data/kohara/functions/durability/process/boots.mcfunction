data modify storage kohara:temp object set from storage kohara:temp player_data.Inventory[{Slot:100b}]
...
execute unless score $player.temp_0 kohara.misc = $player.temp_1 kohara.misc run function kohara:durability/damage/boots
