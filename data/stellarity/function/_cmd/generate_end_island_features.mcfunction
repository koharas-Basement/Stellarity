...
execute if score #continue stellarity.misc matches 1 run function stellarity:util/tellraw/command {string:"generate_end_island_features",fallback:"Manually generated End Island features"}
execute if score #continue stellarity.misc matches 0 run function stellarity:util/tellraw/command {string:"generate_end_island_features.fail",fallback:"Everything is already generated!"}
