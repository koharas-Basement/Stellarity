...
execute unless score #stellarity.config stellarity.config.migrate_vaults matches ..2147483647 run scoreboard players set #stellarity.config stellarity.config.migrate_vaults 0
