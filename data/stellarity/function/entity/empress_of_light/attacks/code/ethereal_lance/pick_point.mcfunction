...
execute as @n[type=area_effect_cloud,tag=stellarity.empress_of_light.ethereal_lance.pick_point] at @s run function stellarity:entity/empress_of_light/attacks/code/ethereal_lance/as_aec
