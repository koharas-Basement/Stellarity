...
playsound minecraft:entity.firework_rocket.launch hostile @a[distance=0..] ~ ~1 ~ 2.2 0.8
...
execute as @a[distance=..2.5,nbt={HurtTime:0s}] run function stellarity:entity/eol/attacks/code/dash/damage
