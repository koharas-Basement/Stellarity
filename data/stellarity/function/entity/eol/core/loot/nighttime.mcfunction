execute store result score #temp1 stellarity.misc run loot spawn ~ ~ ~ loot stellarity:entity/eol/loot_50
execute if score #temp1 stellarity.misc matches 0 run loot spawn ~ ~ ~ loot stellarity:entity/eol/loot
loot spawn ~ ~ ~ loot stellarity:entity/eol/extra_drops/night
