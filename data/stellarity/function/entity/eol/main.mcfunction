...
# Night or day?
  execute unless predicate stellarity:entity/eol/is_daytime run function stellarity:entity/eol/core/loop_night
  execute if predicate stellarity:entity/eol/is_daytime run function stellarity:entity/eol/core/loop_day

# Wing animation
  execute as @n[type=armor_stand,tag=stellarity.eol.as] at @s rotated ~ 0 positioned ^ ^.95 ^-0.175 run function stellarity:entity/eol/animations/wings/flap
...
# Music
  execute if entity @s[tag=!stellarity.eol.death_animation] run function stellarity:entity/eol/music/tick
...
# Death animation
  ...
  function stellarity:entity/eol/animations/death/start with entity @s
  execute if entity @s[tag=stellarity.eol.death_animation] run function stellarity:entity/eol/animations/death/main

# Attacks
  execute if entity @s[tag=stellarity.eol.can_attack] run function stellarity:entity/eol/attacks/loop

scoreboard players add #ambient stellarity.misc 1
execute if score #ambient stellarity.misc matches 200 run function stellarity:entity/eol/core/ambient

execute unless entity @a[distance=..60] run function stellarity:entity/eol/core/despawn

# Prevents cheesing
  execute on vehicle run damage @s 999 out_of_world

# Glowing
  execute if entity @s[predicate=stellarity:entity/eol/is_glowing,tag=!stellarity.eol.glowing] run function stellarity:entity/eol/core/glowing/start
  execute if entity @s[predicate=!stellarity:entity/eol/is_glowing,tag=stellarity.eol.glowing] run function stellarity:entity/eol/core/glowing/stop
