...
# First Trade
  function stellarity:entity/villager/trade_editor/add_enderite_buy {xp:3,max_uses:8,price_multiplier:0.05,buy_a_id:"leather",buy_a_count:10,buy_b_id:"air",buy_b_count:1,sell_count:1}
