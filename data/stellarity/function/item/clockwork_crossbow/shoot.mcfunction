advancement revoke @s only stellarity:event/item/shoot_clockwork_crossbow
...
execute anchored eyes positioned ^ ^-0.287 ^ run function stellarity:item/clockwork_crossbow/smoke
