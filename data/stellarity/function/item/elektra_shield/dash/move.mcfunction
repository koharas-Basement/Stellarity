...
## SFX
  # Particles
    ...
    # Reset fall damage (every tick, as it accumulates FOR WHATEVER REASON)
      summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["stellarity.elektra_shield","smithed.entity","smithed.strict"],potion_contents:{custom_effects:[{id:"minecraft:levitation",amplifier:0b,duration:2,show_particles:0b,show_icon:0b}]},Duration:2,ReapplicationDelay:0,WaitTime:-1,Age:-1}
