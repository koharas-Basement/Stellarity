...
summon area_effect_cloud ~ ~ ~ {Tags:["stellarity.items.fish.crystal_heartfish.aec","stellarity.aec","smithed.entity","smithed.strict"],Duration:21,custom_particle:{type:"block","block_state":"air"}}
