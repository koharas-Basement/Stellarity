...
function stellarity:item/frigid_harvester/item_modifier/aery_sword_update_abilities with storage stellarity:temp aery_sword

function stellarity:item/frigid_harvester/effects/crack/ability
