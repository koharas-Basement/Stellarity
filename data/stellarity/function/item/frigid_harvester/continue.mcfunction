...
execute anchored eyes positioned ^ ^ ^2.5 run function stellarity:item/frigid_harvester/effects/souls
execute unless score #damage stellarity.misc matches 1200.. run \
	function stellarity:item/frigid_harvester/effects/crack/crack
...
function stellarity:item/frigid_harvester/item_modifier/aery_sword_increase_damage with storage stellarity:temp aery_sword
...
execute if score #damage stellarity.misc matches 1200.. run \
	function stellarity:item/frigid_harvester/ultra_max_out
