...
summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["stellarity.anima_conduit","smithed.entity","smithed.strict"],potion_contents:{custom_effects:[{id:"minecraft:regeneration",amplifier:5b,duration:1,show_particles:0b,show_icon:0b}]},Duration:2,ReapplicationDelay:0,WaitTime:-1,Age:-1}
