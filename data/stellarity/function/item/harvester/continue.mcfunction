...
# PATCHES AERY SWORD DAMAGE
  data modify storage stellarity:temp aery_sword.attributes[{type:"minecraft:attack_damage"}].amount set from storage stellarity:temp aery_sword.damage_inc
  data modify storage stellarity:temp aery_sword.attributes[{type:"minecraft:movement_speed"}].amount set from storage stellarity:temp aery_sword.speed
  data modify storage stellarity:temp aery_sword.attributes[{type:"minecraft:attack_speed"}].amount set from storage stellarity:temp aery_sword.atk_speed
