...
# Detonation
execute unless score @s stellarity.items.prismatic_punch.piercing_cooldown matches 1.. anchored eyes if entity @n[type=!#kohara:invalid_targets,dx=0,predicate=!stellarity:item/holding/prismatic_punch] run function stellarity:item/prismatic_punch/detonate/start
execute unless score #exploded stellarity.misc matches 1 unless score @s stellarity.items.prismatic_punch.piercing_cooldown matches 1.. anchored eyes if entity @n[type=!#kohara:invalid_targets,distance=..2.5,predicate=!stellarity:item/holding/prismatic_punch] run function stellarity:item/prismatic_punch/detonate/start
...
function stellarity:item/prismatic_punch/move with storage stellarity:temp prismatic_punch
...
execute if score @s stellarity.misc matches 2.. run function stellarity:item/prismatic_punch/blast_particles

execute if score @s stellarity.misc matches 100.. run function stellarity:item/prismatic_punch/detonate/start_absolute
