...
execute if data storage stellarity:temp book_of_return.dimension run function stellarity:item/spellbooks/return/teleport/summon_marker with storage stellarity:temp book_of_return
execute unless data storage stellarity:temp book_of_return.dimension run schedule function stellarity:item/spellbooks/return/teleport/locate_world_spawn 1t append
