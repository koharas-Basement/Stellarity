...
execute if score @s stellarity.items.spellbook.updraft.animation matches 2 run function stellarity:item/spellbooks/updraft/wave/1
execute if score @s stellarity.items.spellbook.updraft.animation matches 4 run function stellarity:item/spellbooks/updraft/wave/2
execute if score @s stellarity.items.spellbook.updraft.animation matches 6 run function stellarity:item/spellbooks/updraft/wave/3
...
execute if score @s stellarity.items.spellbook.updraft.animation matches 5.. if data entity @s {OnGround:1b} run function stellarity:item/spellbooks/updraft/animation_finish
