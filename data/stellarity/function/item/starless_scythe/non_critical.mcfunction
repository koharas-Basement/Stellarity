...
execute if score #can_sweep stellarity.misc <= #time_since_last_attack kohara.misc anchored eyes positioned ^ ^ ^2.0 run function stellarity:item/starless_scythe/sweep/trigger
