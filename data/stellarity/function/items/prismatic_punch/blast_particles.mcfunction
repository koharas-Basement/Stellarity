...
execute if entity @s[tag=!stellarity.prismatic_blast.multishot] run function stellarity:items/prismatic_punch/particle_cycle/normal
execute if entity @s[tag=stellarity.prismatic_blast.multishot] run function stellarity:items/prismatic_punch/particle_cycle/multishot
