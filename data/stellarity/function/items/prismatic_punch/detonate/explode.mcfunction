execute as @e[type=!#kohara:invalid_targets,distance=..3] run function stellarity:items/prismatic_punch/detonate/damage

# Prismatic Inferno
scoreboard players set #effect.duration stellarity.misc 80
execute as @e[type=!#kohara:invalid_targets,distance=..3] run function stellarity:utils/status_effects/prismatic_inferno/apply
