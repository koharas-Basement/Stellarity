execute if entity @s[predicate=stellarity:items/holding/spellbooks/jinx] run function stellarity:items/spellbooks/jinx/use
execute if entity @s[predicate=stellarity:items/holding/spellbooks/conveyance] run function stellarity:items/spellbooks/conveyance/use
