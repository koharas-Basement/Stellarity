...
# Obstruct Book Walls
  execute as @e[tag=stellarity.obstruct.walls] unless score @s stellarity.entity.live_time matches -1.. run scoreboard players set @s stellarity.entity.live_time 10
