...
summon armor_stand ~0.50450701485292 ~-1.27415153937696 ~-0.34230595720676 {Invulnerable:0b,Pose:{RightArm:[80.0f,0.0f,0.0f]},Rotation:[-90.0f, 0.0f],Tags:["stellarity.aota.sword_holder","smithed.entity","smithed.strict"],Invisible:1b,NoGravity:1b,NoBasePlate:0b,DisabledSlots:4144959,ShowArms:1b,Small:0b,Marker:1b}
loot replace entity @n[type=minecraft:armor_stand,tag=stellarity.aota.sword_holder] weapon.mainhand loot stellarity:item/weapon/dragonblade

summon minecraft:interaction ~ ~-.8 ~ {width:0.4f,height:1f,response:1b,Tags:["stellarity.aota.sword_hitbox","smithed.entity","smithed.strict"]}

function stellarity:mechanic/altar_of_accursed/activate/wave
