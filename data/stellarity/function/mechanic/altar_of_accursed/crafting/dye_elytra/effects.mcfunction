...
$execute as @n[type=item,distance=..1.5,tag=stellarity.aota.minecraft.elytra] unless data entity @s Item.components."minecraft:custom_data"."stellarity.elytra_color" run data modify entity @s Item.components."minecraft:lore" insert 0 value {"translate":"item.dyed","color":$(color),"italic":true}
