...
## champion
  # Helmet
    ...
    function stellarity:mechanic/altar_of_accursed/crafting/macro/craft_armor {parent:"minecraft.netherite_helmet",loot:"stellarity:item/armor/champion/helmet"}
  ...
  # Chestplate
    ...
    if entity @e[type=item,distance=..1.5,tag=stellarity.aota.minecraft.netherite_chestplate] \
    if entity @e[type=item,distance=..1.5,tag=stellarity.aota.stellarity.chorus_plating,scores={stellarity.aota.count=4}] run \
    function stellarity:mechanic/altar_of_accursed/crafting/macro/craft_armor {parent:"minecraft.netherite_chestplate",loot:"stellarity:item/armor/champion/chestplate"}
  ...
  # Leggings
    ...
    if entity @e[type=item,distance=..1.5,tag=stellarity.aota.minecraft.netherite_leggings] \
    if entity @e[type=item,distance=..1.5,tag=stellarity.aota.stellarity.chorus_plating,scores={stellarity.aota.count=4}] run \
    function stellarity:mechanic/altar_of_accursed/crafting/macro/craft_armor {parent:"minecraft.netherite_leggings",loot:"stellarity:item/armor/champion/leggings"}
  ...
  # Boots
    ...
    if entity @e[type=item,distance=..1.5,tag=stellarity.aota.minecraft.netherite_boots] \
    if entity @e[type=item,distance=..1.5,tag=stellarity.aota.stellarity.chorus_plating,scores={stellarity.aota.count=4}] run \
    function stellarity:mechanic/altar_of_accursed/crafting/macro/craft_armor {parent:"minecraft.netherite_boots",loot:"stellarity:item/armor/champion/boots"}
