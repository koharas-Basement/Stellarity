...
# Call of The Void
  ...
  function stellarity:mechanic/altar_of_accursed/crafting/macro/craft_weapon {loot:"stellarity:item/weapon/call_of_the_void",parent:"minecraft.bow"}
...
# Spectral Fury
  ...
  if entity @e[type=item,distance=..1.5,tag=stellarity.aota.minecraft.phantom_membrane,scores={stellarity.aota.count=8}] \
  if entity @e[type=item,distance=..1.5,tag=stellarity.aota.stellarity.enderite_smithing_template,scores={stellarity.aota.count=1}] run \
  function stellarity:mechanic/altar_of_accursed/crafting/macro/craft_weapon {loot:"stellarity:item/weapon/spectral_fury",parent:"stellarity.sharanga"}
