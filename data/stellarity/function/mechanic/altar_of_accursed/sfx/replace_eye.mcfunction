...
execute if entity @p[gamemode=!creative,gamemode=!spectator,distance=..10] run summon item ~ ~.2 ~ {Item:{id:"ender_eye",count:1b},PickupDelay:10,Age:0,Motion:[0d,0.2d,0d],Tags:["stellarity.aota.skip"]} 
