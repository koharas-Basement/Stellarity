...
execute as @p store result score #has_altar stellarity.misc run clear @s[gamemode=creative] chiseled_quartz_block[custom_data={stellarity.item:"altar_of_light"}] 0
