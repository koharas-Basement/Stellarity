...
if entity @e[type=item,tag=stellarity.altar_of_the_accursed.minecraft.elytra,distance=..1.5] run function stellarity:mechanic/altar_of_the_accursed/crafting/dye_elytra/checks
