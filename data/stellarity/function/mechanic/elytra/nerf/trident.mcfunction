# Get which hand the Trident is being held in
  ...
  execute if score #mainhand stellarity.misc matches 1 store result score #enchantment stellarity.misc run data get storage stellarity:temp elytra_nerf.player_data.SelectedItem.components."minecraft:enchantments"."minecraft:riptide" 3
  execute if score #offhand stellarity.misc matches 1 store result score #enchantment stellarity.misc run data get storage stellarity:temp elytra_nerf.player_data.equipment.offhand.components."minecraft:enchantments"."minecraft:riptide" 3
