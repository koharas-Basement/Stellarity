data modify storage stellarity:temp aota.item set from entity @n[type=item,tag=stellarity.aota.minecraft.netherite_chestplate,distance=..1.5] Item.components
