...
execute align xyz positioned ~.5 ~ ~.5 run summon item_display ~ ~0.5 ~ {item:{id:"minecraft:chiseled_quartz_block",count:1,components:{"minecraft:item_model":90000}},brightness:{block:15,sky:15}}
