...
execute if entity @s[type=dragon_fireball] run scoreboard players add @e[type=ender_dragon,tag=fe.ender_dragon] stellarity.dragon.shulker_hell 1
...
execute as @e[type=ender_dragon,tag=fe.ender_dragon,scores={stellarity.dragon.health_percent=34..66}] \
...
execute as @e[type=ender_dragon,tag=fe.ender_dragon,scores={stellarity.dragon.health_percent=..33}] \
unless score @s stellarity.dragon.time_chainfiring matches 1.. run \
