summon shulker ~ ~ ~ {NoAI:1b,Invulnerable:1b,Color:10,Tags:["stellarity.dragon_shulker"],DeathLootTable:"",attributes:[{id:"max_health",base:20d},{id:"armor_toughness",base:4d},{id:"follow_range",base:40d}]}
