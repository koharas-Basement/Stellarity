...
execute as @e[type=marker,tag=stellarity.dragon_marker] at @s run function stellarity:mob/dragon/death/finish_as_marker
...
schedule function stellarity:mob/dragon/death/activate_aota_sound 5s
schedule function stellarity:mob/dragon/death/activate_aota 8s
...
execute unless entity @e[type=marker,tag=stellarity.altar_of_accursed,tag=stellarity.aota_activated] run \
	schedule function stellarity:mob/dragon/play_track 230t
...
execute if entity @e[type=marker,tag=stellarity.altar_of_accursed,tag=stellarity.aota_activated] run \
	schedule function stellarity:mob/dragon/play_track 70t
