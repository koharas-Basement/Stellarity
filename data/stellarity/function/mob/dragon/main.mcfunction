...
execute as @e[type=end_crystal,nbt={ShowBottom:1b},distance=..200] at @s run function stellarity:mob/dragon/crystal/loop
# Make Dragon invulnerable if there is more than 1 Crystal
execute if score #crystal_count stellarity.misc matches 1.. run function stellarity:mob/dragon/crystal/update_bossbar
execute unless score #crystal_count stellarity.misc matches 1.. run function stellarity:mob/dragon/crystal/hide_bossbar
...
execute if score @s stellarity.dragon.health_old < @s stellarity.dragon.health run function stellarity:mob/dragon/prevent_heal
...
execute if predicate kohara:chance/6percent run function stellarity:mob/dragon/beam_thingy/spawn
...
# Music
execute if entity @s[tag=!stellarity.to_portal,tag=!stellarity.at_portal] run function stellarity:mob/dragon/music/tick
...
execute unless score @s[tag=!stellarity.at_portal] stellarity.misc matches 5..7 run function stellarity:mob/dragon/trail
...
execute if score @s stellarity.misc matches 5 run function stellarity:mob/dragon/attacks/roar_breath/main
execute unless score @s stellarity.dragon.shulker_hell matches 4 as @e[type=dragon_fireball] at @s run function stellarity:mob/dragon/attacks/fireball/summon
execute if score @s stellarity.dragon.shulker_hell matches 4 as @e[type=dragon_fireball] at @s run function stellarity:mob/dragon/attacks/shulker_hell/trigger
execute if score @s[tag=!stellarity.at_portal,scores={stellarity.dragon.health_percent=..99}] stellarity.misc matches 4 run \
	function stellarity:mob/dragon/attacks/take_off/main
execute if score @s[scores={stellarity.dragon.perch_cooldown=1..}] stellarity.misc matches 2..3 run \
	data modify entity @s DragonPhase set value 0
execute if score @s stellarity.dragon.time_chainfiring matches 1.. run function stellarity:mob/dragon/attacks/chainfire/tickdown
execute unless score @s[scores={stellarity.dragon.health_percent=..50,stellarity.misc=0..1}] stellarity.dragon.ball_of_blight_cooldown matches 1.. run function stellarity:mob/dragon/attacks/ball_of_blight/cast
...
execute if score @s[tag=!stellarity.dragon.respawned_crystals] stellarity.dragon.health_percent matches ..25 run function stellarity:mob/dragon/attacks/revive_crystals/initiate

# Heartbeat while below 25% health
# It only gets quicker and quicker as the Dragon knows it is closer to its death
execute if score @s stellarity.dragon.health_percent matches ..25 run function stellarity:mob/dragon/heartbeat/main

# Fly to portal to die
execute if score @s[tag=!stellarity.at_portal] stellarity.dragon.health matches 0..1 run function stellarity:mob/dragon/death/fly_to_portal
...
execute if entity @s[tag=stellarity.at_portal] run function stellarity:mob/dragon/death/at_portal_loop

execute as @e[type=shulker,tag=stellarity.dragon_shulker] at @s run particle witch ~ ~0.2 ~ 0.4 0.4 0.4 0.04 1 normal
execute as @e[type=shulker_bullet,tag=stellarity.dragon_bullet] at @s run function stellarity:mob/dragon/attacks/shulker_hell/loop_as_bullet
