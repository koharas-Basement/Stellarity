...
execute as @e[type=end_crystal,predicate=stellarity:location/in_the_end,nbt={ShowBottom:1b}] at @s run function stellarity:mob/dragon/spawn/crystal_transitions/cancel
execute as @e[type=end_crystal,tag=fe.respawn_crystal] at @s run function stellarity:mob/dragon/spawn/crystal_transitions/respawn
