...
execute as @e[type=minecraft:end_crystal,predicate=stellarity:location/in_the_end] at @s run function stellarity:mob/dragon/spawn/crystal_transitions/normal
