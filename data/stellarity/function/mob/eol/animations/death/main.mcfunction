...
execute if score @s stellarity.eol.animation matches 60 run function stellarity:mob/eol/animations/death/end

execute if score @s[tag=stellarity.eol.full_daytime] stellarity.eol.animation matches 60 run function stellarity:mob/eol/core/loot/daytime
execute if score @s[tag=!stellarity.eol.full_daytime] stellarity.eol.animation matches 60 run function stellarity:mob/eol/core/loot/nighttime
