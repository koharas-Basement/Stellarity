...
execute as @n[type=area_effect_cloud,tag=stellarity.eol.ethereal_lance.pick_point] at @s run function stellarity:mob/eol/attacks/code/ethereal_lance/as_aec
