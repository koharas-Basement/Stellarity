...
execute if score @s stellarity.eol.attack_duration matches 7.. run function stellarity:mob/eol/attacks/code/dash/move

execute if score @s stellarity.eol.attack_duration matches 15.. unless block ^ ^ ^1.5 #kohara:non_solid run function stellarity:mob/eol/attacks/code/dash/found_block
