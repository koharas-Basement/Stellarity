...
execute if score #bolts.timer stellarity.misc matches 4 as @n[type=armor_stand,tag=stellarity.eol.as] at @s rotated ~ 0 positioned ^-.3 ^1 ^0.3 run function stellarity:mob/eol/attacks/code/prismatic_bolts/summon
