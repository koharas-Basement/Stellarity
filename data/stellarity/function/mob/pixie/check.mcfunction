...
execute unless score #pixie_count stellarity.misc matches 30.. run function stellarity:mob/pixie/spawn
execute unless score #allay_count stellarity.misc matches 5.. if predicate kohara:chance/5percent run function stellarity:mob/pixie/allay
