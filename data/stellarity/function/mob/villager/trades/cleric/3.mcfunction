# First Trade
  function stellarity:mob/villager/trade_editor/add_from_loot_table {max_uses:3,price_multiplier:0.05,loot_table:"stellarity:village/trades/cleric/journeyman_potion",buy_a_count:7,buy_b_id:"air",buy_b_count:1,sell_count:1,xp:10}
