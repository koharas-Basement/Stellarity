...
# Second Trade
  function stellarity:mob/villager/trade_editor/add_enderite_sell_with_modifier {max_uses:4,price_multiplier:0.05,buy_a_count:8,buy_b_id:"air",buy_b_count:1,sell:"bow",sell_count:1,modifier:"stellarity:villager/common/enchant_15_29",xp:10}
