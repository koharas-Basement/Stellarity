...
# First Trade
  function stellarity:mob/villager/trade_editor/add_enderite_sell_reverse_order_with_modifier {xp:8,max_uses:6,price_multiplier:0.05,buy_a_id:"arrow",buy_a_count:8,buy_b_count:2,sell:"tipped_arrow",sell_count:8,modifier:"stellarity:villager/fletcher/levitation_arrow"}
