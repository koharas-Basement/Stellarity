...
execute if score @s stellarity.random_number matches 2 run \
function stellarity:mob/villager/trade_editor/add_enderite_sell_reverse_order_with_modifier {xp:8,max_uses:3,price_multiplier:0.2,buy_a_id:"book",buy_a_count:1,buy_b_count:15,sell:"book",sell_count:1,modifier:"stellarity:villager/librarian/novice_enchant"}
