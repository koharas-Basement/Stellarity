...
function stellarity:mob/villager/trade_editor/add_enderite_sell_reverse_order_with_modifier {xp:20,max_uses:2,price_multiplier:0.2,buy_a_id:"book",buy_a_count:1,buy_b_count:40,sell:"book",sell_count:1,modifier:"stellarity:villager/librarian/expert_enchant"}
