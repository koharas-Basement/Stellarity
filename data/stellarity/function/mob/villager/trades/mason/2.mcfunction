...
function stellarity:mob/villager/trade_editor/add_sell_for_loot_table {xp:4,max_uses:6,price_multiplier:0.05,loot_table:"stellarity:item/food/fish/amethyst_budfish",buy_a_count:1,buy_b_id:"air",buy_b_count:1,sell:"amethyst_shard",sell_count:4}

execute if score @s stellarity.random_number matches 2 run \
function stellarity:mob/villager/trade_editor/add_sell_for_loot_table {xp:5,max_uses:6,price_multiplier:0.05,loot_table:"stellarity:item/food/fish/amethyst_budfish",buy_a_count:1,buy_b_id:"air",buy_b_count:1,sell:"quartz",sell_count:8}
