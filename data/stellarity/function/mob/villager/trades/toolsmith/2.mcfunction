...
function stellarity:mob/villager/trade_editor/add_enderite_sell_with_modifier {xp:10,max_uses:3,price_multiplier:0.05,buy_a_count:6,buy_b_id:"air",buy_b_count:1,sell:"iron_axe",sell_count:1,modifier:"stellarity:villager/common/enchant_15_29"}

execute if score @s stellarity.random_number matches 2 run \
function stellarity:mob/villager/trade_editor/add_enderite_sell_with_modifier {xp:10,max_uses:3,price_multiplier:0.05,buy_a_count:6,buy_b_id:"air",buy_b_count:1,sell:"iron_pickaxe",sell_count:1,modifier:"stellarity:villager/common/enchant_15_29"}
