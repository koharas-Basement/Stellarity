...
# Second Trade
function stellarity:mob/villager/trade_editor/add_enderite_sell_with_modifier {xp:8,max_uses:3,price_multiplier:0.05,buy_a_count:5,buy_b_id:"air",buy_b_count:1,sell:"iron_sword",sell_count:1,modifier:"stellarity:village/trades/weaponsmith/1/2"}
