...
# Second Trade
  function stellarity:mob/villager/trade_editor/add_enderite_sell_reverse_order_with_modifier {xp:12,max_uses:4,price_multiplier:0.05,buy_a_id:"book",buy_a_count:1,buy_b_count:20,sell:"book",sell_count:1,modifier:"stellarity:villager/weaponsmith/journeyman_enchant"}
