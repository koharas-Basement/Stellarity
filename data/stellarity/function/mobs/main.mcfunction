...
execute as @e[type=slime,predicate=stellarity:locations/in_the_end,tag=!stellarity.voided_slime] at @s run function stellarity:mobs/voided_slime/abort_offsprings
