attribute @s minecraft:generic.attack_damage modifier add stellarity:mob_stat 4 add_value
...
attribute @s minecraft:generic.follow_range modifier add stellarity:mob_stat 0.33 add_multiplied_total
