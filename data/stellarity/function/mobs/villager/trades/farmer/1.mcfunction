...
# Second Trade
function stellarity:mobs/villager/trade_editor/add_enderite_sell {max_uses:12,price_multiplier:0.05,sell:"bread",buy_a_count:1,buy_b_id:"air",buy_b_count:1,sell_count:6,xp:2}
