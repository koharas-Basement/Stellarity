...
execute if score #trade stellarity.misc matches 1 run \
    function stellarity:mobs/villager/trade_editor/add_enderite_sell_with_modifier {xp:8,max_uses:3,price_multiplier:0.05,buy_a_count:1,buy_b_id:"air",buy_b_count:1,sell:"iron_hoe",sell_count:1,modifier:"stellarity:villager/toolsmith/1/2/1"}

execute if score #trade stellarity.misc matches 2 run \
    function stellarity:mobs/villager/trade_editor/add_enderite_sell_with_modifier {xp:8,max_uses:3,price_multiplier:0.05,buy_a_count:1,buy_b_id:"air",buy_b_count:1,sell:"iron_shovel",sell_count:1,modifier:"stellarity:villager/toolsmith/1/2/2"}
