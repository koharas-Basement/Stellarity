...
# First Trade
function stellarity:mobs/villager/trade_editor/add_enderite_sell_with_modifier {xp:8,max_uses:3,price_multiplier:0.05,buy_a_count:6,buy_b_id:"air",buy_b_count:1,sell:"iron_axe",sell_count:1,modifier:"stellarity:villager/weaponsmith/2/1"}
