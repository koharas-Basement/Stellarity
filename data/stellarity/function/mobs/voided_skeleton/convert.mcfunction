...
execute if score #random stellarity.misc matches 1..2 run loot replace entity @s weapon loot stellarity:items/call_of_the_void
execute if score #random stellarity.misc matches 3 run item replace entity @s weapon with stone_sword[custom_model_data=90000]
...
execute at @s if biome ~ ~ ~ #stellarity:snowy run function stellarity:mobs/voided_skeleton/frozen_spikes
