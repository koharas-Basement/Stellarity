summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["stellarity.voided","smithed.entity","smithed.strict"],potion_contents:{custom_effects:[{id:"minecraft:wither",amplifier:0,duration:2,show_icon:0b,show_particles:0b}]},Duration:2,ReapplicationDelay:0,WaitTime:-1,Age:-1}
