...
execute if score @s kohara.misc matches 20 run data merge entity @s {transformation:{left_rotation:[0f,0f,0f,-1f],right_rotation:[0f,0f,1f,0f],scale:[0.1f,0.0000000001f,0.1f]},interpolation_duration:9,start_interpolation:-1}
