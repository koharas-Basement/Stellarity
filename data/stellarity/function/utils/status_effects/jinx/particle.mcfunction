...
execute positioned ~ ~1.3 ~ run function kohara:particles/spawn_particle {speed:30,billboard:center,model:"stellarity:particle/jinx",despawn_value:30,state:spread,spread_initial:1.8,spread_radius:2.2,id:jinx}
