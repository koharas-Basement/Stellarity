...
execute \
	facing entity @p[predicate=stellarity:items/holding/chorus_dagger,predicate=kohara:player/is_sneaking] eyes \
	rotated ~ 0 \
	positioned ^ ^ ^1 \
	as @p[predicate=stellarity:items/holding/chorus_dagger,predicate=kohara:player/is_sneaking] \
	rotated as @s \
	run \
