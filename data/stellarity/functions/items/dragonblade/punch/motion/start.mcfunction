...
# Cool little visuals
execute at @p[predicate=stellarity:items/holding_dragonblade,predicate=kohara:player/is_sneaking] facing entity @s eyes rotated ~ 0 positioned ^ ^1.05 ^1 run function stellarity:items/dragonblade/punch/special_fx/particle_aec_spawn
