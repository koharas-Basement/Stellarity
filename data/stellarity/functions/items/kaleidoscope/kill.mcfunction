...
execute if score @s[advancements={stellarity:events/items/attack_with_kaleidoscope=false}] stellarity.items.kaleidoscope.charge matches 33..65 anchored eyes positioned ^ ^ ^2.5 run function stellarity:items/kaleidoscope/charges/1
