...
execute if predicate kohara:chance/35percent run loot spawn ~ ~ ~ loot stellarity:pandoras_barrel/drops/flower_forest
...
execute if predicate kohara:chance/25percent run function stellarity:items/pandoras_barrel/summons/dark/flower_forest 
