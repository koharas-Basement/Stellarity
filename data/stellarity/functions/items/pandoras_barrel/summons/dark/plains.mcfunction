...
execute if predicate kohara:chance/35percent run loot spawn ~ ~ ~ loot stellarity:pandoras_barrel/drops/plains
...
execute if predicate kohara:chance/25percent run function stellarity:items/pandoras_barrel/summons/dark/plains 
