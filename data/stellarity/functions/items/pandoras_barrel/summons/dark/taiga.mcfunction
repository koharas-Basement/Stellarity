...
execute if predicate kohara:chance/20percent run summon spider ~ ~ ~
execute if predicate kohara:chance/25percent run summon zombie_villager ~ ~ ~
...
execute if predicate kohara:chance/10percent run summon stray ~ ~ ~
