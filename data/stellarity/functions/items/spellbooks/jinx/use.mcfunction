...
execute if score #mainhand stellarity.misc matches 0 run \
	loot replace entity @s[gamemode=!creative,gamemode=!spectator] weapon.offhand loot stellarity:items/spellbooks/jinx
execute if score #mainhand stellarity.misc matches 0 run \
...
execute if score #mainhand stellarity.misc matches 1 run \
	loot replace entity @s[gamemode=!creative,gamemode=!spectator] weapon.mainhand loot stellarity:items/spellbooks/jinx
execute if score #mainhand stellarity.misc matches 1 run \
