...
execute if score #upgrades stellarity.misc matches 1..6 if predicate kohara:chance/50percent run data modify storage stellarity:temp natures_wrath.chosen set value "normal"
execute if score #upgrades stellarity.misc matches 7.. if predicate kohara:chance/33percent run data modify storage stellarity:temp natures_wrath.chosen set value "normal"
