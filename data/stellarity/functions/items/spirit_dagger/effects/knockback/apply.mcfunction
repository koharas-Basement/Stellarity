...
execute facing entity @p[predicate=stellarity:items/holding/spirit_dagger/both] feet rotated ~180 0 run function stellarity:items/spirit_dagger/effects/knockback/get_distance
