...
execute if score @s[tag=kohara.boss] stellarity.items.tamaris.math.health.percentage matches ..10 run tag @s add stellarity.items.tamaris.executable
# Other mobs
execute if score @s[type=!#kohara:boss,tag=!kohara.boss] stellarity.items.tamaris.math.health.percentage matches ..25 run tag @s add stellarity.items.tamaris.executable
