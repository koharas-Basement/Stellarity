data modify storage stellarity:temp aota.item set from entity @e[type=item,tag=stellarity.aota.netherite_helmet,distance=..1.5,limit=1] Item.tag
...
loot spawn ~ ~-.4 ~ loot stellarity:items/armors/chorus_champion_armor/helmet
