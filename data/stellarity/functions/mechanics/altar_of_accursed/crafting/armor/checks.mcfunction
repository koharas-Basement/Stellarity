## Hallowed
# Helmet
execute if entity @e[type=item,tag=stellarity.aota.netherite_helmet,distance=..1.5] \
...
# Chestplate
execute if entity @e[type=item,tag=stellarity.aota.netherite_chestplate,distance=..1.5] \
	if entity @e[type=item,tag=stellarity.aota.hallowed_ingots,distance=..1.5] run \
	function stellarity:mechanics/altar_of_accursed/crafting/armor/hallowed/chestplate

# Leggings
execute if entity @e[type=item,tag=stellarity.aota.netherite_leggings,distance=..1.5] \
	if entity @e[type=item,tag=stellarity.aota.hallowed_ingots,distance=..1.5] run \
	function stellarity:mechanics/altar_of_accursed/crafting/armor/hallowed/leggings

# Boots
execute if entity @e[type=item,tag=stellarity.aota.netherite_boots,distance=..1.5] \
	if entity @e[type=item,tag=stellarity.aota.hallowed_ingots,distance=..1.5] run \
...
# Helmet
execute if entity @e[type=item,tag=stellarity.aota.netherite_helmet,distance=..1.5] \
	if entity @e[type=item,tag=stellarity.aota.ancient_plating,distance=..1.5] run \
...
## Shulker
# Helmet
execute if entity @e[type=item,tag=stellarity.aota.shulker_shells,distance=..1.5] \
