data modify storage stellarity:temp aota.enchants set from entity @e[type=item,tag=stellarity.aota.netherite_helmet,distance=..1.5,limit=1] Item.tag.Enchantments
...
loot spawn ~ ~-.4 ~ loot stellarity:items/armors/hallowed_armor/helmet
