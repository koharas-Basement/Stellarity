data modify storage stellarity:temp aota.enchants set from entity @e[type=item,tag=stellarity.aota.netherite_sword,distance=..1.5,limit=1] Item.tag.Enchantments
