...
bossbar set stellarity:crystal_count name [{"translate":"stellarity.bossbars.crystals_left","fallback":"Crystals Left:","color":"#4C0081"}," ",{"score":{"name": "#crystal_count","objective": "stellarity.misc"},"color":"#620081"}]
