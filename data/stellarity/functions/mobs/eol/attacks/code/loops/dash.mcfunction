...
execute if score @s stellarity.eol.attack_duration matches 15.. unless block ^ ^ ^1.5 #kohara:non_solid run function stellarity:mobs/eol/attacks/code/dash/found_block
