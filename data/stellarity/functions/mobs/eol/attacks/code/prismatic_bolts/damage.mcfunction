...
function kohara:damage/calculate {armor_penetration:0,damage_boost_efficiency:0,damage_type:"stellarity:empress_of_light/projectile",tag:"stellarity.damage.eol.prismatic_bolts"}
