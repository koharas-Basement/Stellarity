...
execute if score out stellarity.misc matches 1 run loot spawn ~ ~-5 ~ loot stellarity:items/clockwork_crossbow
...
execute if score out stellarity.misc matches 2 run loot spawn ~ ~-5 ~ loot stellarity:items/sharanga
