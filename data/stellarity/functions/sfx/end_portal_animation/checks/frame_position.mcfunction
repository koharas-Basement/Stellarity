...
function stellarity:sfx/end_portal_animation/stopsound
schedule function stellarity:sfx/end_portal_animation/stopsound 1t
schedule function stellarity:sfx/end_portal_animation/stopsound 2t
