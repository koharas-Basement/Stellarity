# Sound
damage @s[type=!player] 0.00000001 stellarity:empress_of_light/projectile

data modify entity @s Silent set value 1b

# Knockback
damage @s 0.00000001 stellarity:empress_of_light/projectile by @e[limit=1,sort=nearest,tag=stellarity.damage.attacker]

execute if score #damage stellarity.misc matches 2048.. run damage @s 204.8 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 2048.. run scoreboard players remove #damage stellarity.misc 2048

execute if score #damage stellarity.misc matches 1024.. run damage @s 102.4 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 1024.. run scoreboard players remove #damage stellarity.misc 1024

execute if score #damage stellarity.misc matches 512.. run damage @s 51.2 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 512.. run scoreboard players remove #damage stellarity.misc 512

execute if score #damage stellarity.misc matches 256.. run damage @s 25.6 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 256.. run scoreboard players remove #damage stellarity.misc 256

execute if score #damage stellarity.misc matches 128.. run damage @s 12.8 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 128.. run scoreboard players remove #damage stellarity.misc 128

execute if score #damage stellarity.misc matches 64.. run damage @s 6.4 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 64.. run scoreboard players remove #damage stellarity.misc 64

execute if score #damage stellarity.misc matches 32.. run damage @s 3.2 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 32.. run scoreboard players remove #damage stellarity.misc 32

execute if score #damage stellarity.misc matches 16.. run damage @s 1.6 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 16.. run scoreboard players remove #damage stellarity.misc 16

execute if score #damage stellarity.misc matches 8.. run damage @s 0.8 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 8.. run scoreboard players remove #damage stellarity.misc 8

execute if score #damage stellarity.misc matches 4.. run damage @s 0.4 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 4.. run scoreboard players remove #damage stellarity.misc 4

execute if score #damage stellarity.misc matches 2.. run damage @s 0.2 stellarity:empress_of_light/projectile
execute if score #damage stellarity.misc matches 2.. run scoreboard players remove #damage stellarity.misc 2

execute if score #damage stellarity.misc matches 1.. run damage @s 0.1 stellarity:empress_of_light/projectile
