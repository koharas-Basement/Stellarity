function stellarity:util/tellraw/help {command:"configuration",description:"Configuration menu for a very limited amount of things. Configs are saved per-world and not globally"}
