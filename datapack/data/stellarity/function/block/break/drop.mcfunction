...
execute at @s align xyz unless entity @n[type=item,dx=1,dy=1,dz=1,nbt={Item:{id:"minecraft:grass_block"}}] if data entity @s data."stellarity:block"{"model":"stellarity:ender_grass_block"} run scoreboard players set @s stellarity.misc2 1
