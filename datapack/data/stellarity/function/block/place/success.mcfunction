...
$setblock ~ ~ ~ $(block)
$summon minecraft:item_display ~ ~ ~ {Tags:["smithed.entity","smithed.strict","stellarity.block"],transformation:{translation:[0f,0f,0f],left_rotation:[0f,0f,0f,1f],scale:[1.01f,1.01f,1.01f],right_rotation:[0f,0f,0f,1f]},item:{id:"minecraft:stone",components:{"minecraft:item_model":"$(model)"}},brightness:{sky:10,block:10}}
...
execute if data entity @s data."stellarity:block"{}
