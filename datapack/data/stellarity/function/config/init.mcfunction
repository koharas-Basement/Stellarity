...
execute unless score #stellarity.config stellarity.config.empress_of_light_health matches ..2147483647 run scoreboard players set #stellarity.config stellarity.config.empress_of_light_health 500
...
execute unless score #stellarity.config stellarity.config.shulking_health matches ..2147483647 run scoreboard players set #stellarity.config stellarity.config.shulking_health 500
