...
execute if entity @s[scores={stellarity.empress_of_light.animation=101..},tag=stellarity.empress_of_light.radiant] run function stellarity:entity/empress_of_light/animations/spawn/aurora/radiant
