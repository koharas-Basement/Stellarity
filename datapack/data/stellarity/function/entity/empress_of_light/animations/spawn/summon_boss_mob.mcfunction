...
# Armor Stand for the model
  summon armor_stand ~ ~-1.5 ~ {Pose:{LeftLeg:[8f,347f,0f],RightLeg:[10f,18f,0f],LeftArm:[349f,333f,355f],RightArm:[341f,12f,5f]},ShowArms:1b,Tags:["stellarity.empress_of_light.armor_stand","smithed.entity","smithed.strict"],Marker:1b,Invisible:0b,NoGravity:1b,NoBasePlate:1b}
...
execute if predicate stellarity:entity/empress_of_light/is_daytime run data merge entity @n[type=armor_stand,tag=stellarity.empress_of_light.armor_stand] {equipment:{ \
...
execute unless predicate stellarity:entity/empress_of_light/is_daytime run data merge entity @n[type=armor_stand,tag=stellarity.empress_of_light.armor_stand] {equipment:{\
head:{id:"minecraft:player_head",components:{"minecraft:profile":{id:[I;27748125,144067456,-1274466997,-1657885897],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTZjNzA1ZDhkZTc4ZTZiMDdjNjdiMTVlNDRiM2NlY2VlNDM0OWZmMTJlODFlNWU0NzdiYWU2YjYyZDI2OGJmIn19fQ=="}]}},count:1b},\
