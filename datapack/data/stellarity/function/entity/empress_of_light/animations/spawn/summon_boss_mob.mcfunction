...
# Armor Stand for the model
  execute if entity @s[tag=stellarity.empress_of_light.nighttime] run summon item_display ~ ~-1.5 ~ {Tags:["stellarity.empress_of_light.model","smithed.entity","smithed.strict"],NoGravity:1b,item:{id:"leather_horse_armor",components:{item_model:"stellarity:_technical/empress_of_light"}},transformation:{scale:[2.5,2.5,2.5],translation:[0.1,1,-0.1],left_rotation:[0,0,0,1],right_rotation:[0,0,0,1]},teleport_duration:1}
  execute if entity @s[tag=stellarity.empress_of_light.daytime] run summon item_display ~ ~-1.5 ~ {Tags:["stellarity.empress_of_light.model","smithed.entity","smithed.strict"],NoGravity:1b,item:{id:"leather_horse_armor",components:{item_model:"stellarity:_technical/empress_of_light_daylight"}},transformation:{scale:[2.5,2.5,2.5],translation:[0.1,1,-0.1],left_rotation:[0,0,0,1],right_rotation:[0,0,0,1]},teleport_duration:1}
  #execute if entity @s[tag=stellarity.empress_of_light.radiant] run summon item_display ~ ~-1.5 ~ {Tags:["stellarity.empress_of_light.model","smithed.entity","smithed.strict"],NoGravity:1b,item:{id:"leather_horse_armor",components:{item_model:"stellarity:_technical/empress_of_light_radiant"}},transformation:{scale:[2.5,2.5,2.5],translation:[0.1,1,-0.1],left_rotation:[0,0,0,1],right_rotation:[0,0,0,1]},teleport_duration:1}
