summon item_display ~ ~-.5 ~ {Tags:["stellarity.empress_of_light.ethereal_lance","stellarity.empress_of_light.ethereal_lance.no_rotate","stellarity.marker","smithed.entity","smithed.strict"],item:{id:"leather_horse_armor",components:{item_model:"stellarity:_technical/ethereal_lance"}},teleport_duration:1}
execute rotated ~ ~ as @n[type=item_display,tag=stellarity.empress_of_light.ethereal_lance] at @s run tp @s ~ ~ ~ ~ ~
