...
execute if score #bolts.timer stellarity.misc matches 4 as @n[type=armor_stand,tag=stellarity.empress_of_light.as] at @s rotated ~ 0 positioned ^-.3 ^1 ^0.3 run function stellarity:entity/empress_of_light/attacks/code/prismatic_bolts/summon
