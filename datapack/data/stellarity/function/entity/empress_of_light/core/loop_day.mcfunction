...
execute if score @s stellarity.empress_of_light.hurt_time matches 10 as @n[type=armor_stand,tag=stellarity.empress_of_light.as] at @s run function stellarity:entity/empress_of_light/core/model/hurt
execute if score @s[tag=!stellarity.empress_of_light.hurt_10] stellarity.empress_of_light.hurt_time matches 9 as @n[type=armor_stand,tag=stellarity.empress_of_light.as] at @s run function stellarity:entity/empress_of_light/core/model/hurt
execute if score @s stellarity.empress_of_light.hurt_time matches 1 as @n[type=armor_stand,tag=stellarity.empress_of_light.as] at @s run function stellarity:entity/empress_of_light/core/model/daytime
