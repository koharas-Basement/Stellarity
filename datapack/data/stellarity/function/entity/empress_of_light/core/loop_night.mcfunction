...
execute if score @s stellarity.empress_of_light.hurt_time matches 1 as @n[type=armor_stand,tag=stellarity.empress_of_light.as] at @s run function stellarity:entity/empress_of_light/core/model/normal
