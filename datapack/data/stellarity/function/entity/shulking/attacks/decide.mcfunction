...
# attack
  execute store result score @s stellarity.misc2 run random value 1..100

execute if score @s stellarity.misc2 matches 1..100 run function stellarity:entity/shulking/attacks/spikes
