...
id:"shulker", Invulnerable:true,attributes:[{id:"minecraft:scale",base:0.35},{id:"follow_range",base:128}],Tags:["smithed.entity","smithed.strict","stellarity.shulking.rod_shulker"]   \
}],\
