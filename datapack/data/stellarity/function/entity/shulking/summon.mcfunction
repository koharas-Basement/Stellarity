...
Passengers:[{id:"shulker", NoAI:true, Tags:["stellarity.shulking.body","smithed.entity","smithed.strict"],CustomName:{"color":"#FF00FF",translate:"entity.stellarity.shulking"},CustomNameVisible:false,attributes:[{id:"minecraft:scale",base:2},{id:"follow_range",base:128},{id:"max_health",base:500}]}] \
}
