...
function stellarity:entity/villager/trade_editor/add_enderite_buy {max_uses:12,price_multiplier:0.05,buy_a_id:"paper",buy_a_count:28,buy_b_id:"air",buy_b_count:1,sell_count:1,xp:2}
