function stellarity:entity/villager/trade_editor/add_enderite_buy {max_uses:14,price_multiplier:0.05,buy_a_id:"glass_pane",buy_a_count:14,buy_b_id:"air",buy_b_count:1,sell_count:1,xp:8}
