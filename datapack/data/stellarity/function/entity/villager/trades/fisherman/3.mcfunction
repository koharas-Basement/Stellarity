# First Trade
  function stellarity:entity/villager/trade_editor/add_enderite_sell_with_modifier {max_uses:2,price_multiplier:0.05,buy_a_count:3,buy_b_id:"air",buy_b_count:1,sell:"fishing_rod",sell_count:1,modifier:"stellarity:villager/common/enchant_15_29",xp:4}
