...
execute if predicate {"type":"minecraft:any_of","terms":[{"type":"minecraft:inverted","term":{"type":"minecraft:entity_scores","entity":"this","scores":{"stellarity.item.armors.champion_armor.until_combo_reset":{"min":1}}}},{"type":"minecraft:entity_scores","entity":"this","scores":{"stellarity.item.armors.champion_armor.until_combo_reset":{"max":30}}}]} run function stellarity:item/armor/champion/increase_damage
