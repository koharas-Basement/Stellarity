...
data modify storage stellarity:temp shulker_armor.target set from entity @a[limit=1,sort=nearest,tag=stellarity.item.shulker_armor.attacker,distance=..24] UUID
