...
summon area_effect_cloud ~ ~ ~ {Tags:["stellarity.items.fish.crystal_heartfish.area_effect_cloud","stellarity.area_effect_cloud","smithed.entity","smithed.strict"],Duration:21,custom_particle:{type:"block","block_state":"air"}}
