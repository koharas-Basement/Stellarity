...
execute if score @s stellarity.item.aery_sword.progress.anima_conduit matches 1.. \
...
execute if score @s stellarity.item.aery_sword.progress.arctic_wind matches 1.. \
...
execute if score @s stellarity.item.aery_sword.progress.cryonics matches 1.. \
...
execute if score @s stellarity.item.aery_sword.progress.echo matches 1.. \
...
execute if score @s stellarity.item.aery_sword.progress.embrittlement matches 1.. \
...
execute if score @s stellarity.item.aery_sword.progress.frost_barrier matches 1.. \
...
execute if score @s stellarity.item.aery_sword.progress.frostburn matches 5.. \
...
execute if score @s stellarity.item.aery_sword.progress.piercing_cold matches 1.. \
