...
# Add an empty line
  execute if predicate {"type": "minecraft:inverted","term": {"type": "minecraft:all_of","terms": [{"type": "minecraft:value_check","value": {"type": "minecraft:score","target": {"type": "minecraft:fixed","name": "#damage"},"score": "stellarity.misc"},"range": 1200},{"type": "minecraft:value_check","value": {"type": "minecraft:score","target": {"type": "minecraft:fixed","name": "#ability_count"},"score": "stellarity.misc"},"range": 3}]}} run data modify storage stellarity:temp harvester.lore append value {"text":""}
