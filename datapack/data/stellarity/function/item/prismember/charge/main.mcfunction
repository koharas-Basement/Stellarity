...
execute if score @s[tag=!stellarity.items.prismember.ready] stellarity.items.prismember.charge matches 8 run function stellarity:item/prismember/charge/ready
