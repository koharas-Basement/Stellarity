...
execute if score @s stellarity.misc matches 1.. if predicate {"type":"minecraft:inverted","term":{"type":"minecraft:entity_properties","entity":"this","predicate":{"passenger":{}}}} run function stellarity:item/sandstorm_trident/wind_tunnel/movement/remove_block_display
