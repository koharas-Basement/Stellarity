...
summon area_effect_cloud ~ ~ ~ {Duration:100000,Tags:["stellarity.wind_tunnel","stellarity.aec","smithed.entity","smithed.strict"],custom_particle:{type:"block","block_state":"air"}}
