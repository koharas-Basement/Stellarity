...
summon item_display ~ ~ ~ {Tags:["stellarity.satchel_of_voids.stationary","smithed.entity","smithed.strict"],item:{id:"stick",count:1,components:{item_model:"stellarity:_util/satchel_of_voids"}},transformation:[1.001f,0f,0f,0f,0f,1.001f,0f,0f,0f,0f,1.001f,0f,0f,0f,0f,1f],brightness:{block:15,sky:15}}
