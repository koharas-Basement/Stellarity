...
execute if data entity @s inBlockState run function stellarity:item/sharanga/bolt/kill
execute if score @s stellarity.misc matches 61.. run function stellarity:item/sharanga/bolt/kill
