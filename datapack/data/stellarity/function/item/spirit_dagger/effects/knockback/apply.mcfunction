...
execute facing entity @p[predicate=stellarity:item/holding/spirit_dagger/both] feet rotated ~180 0 run function stellarity:item/spirit_dagger/effects/knockback/get_distance
