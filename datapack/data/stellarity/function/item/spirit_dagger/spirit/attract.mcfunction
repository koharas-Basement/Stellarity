...
summon minecraft:area_effect_cloud ~ ~ ~ {Age:0,Duration:1,Tags:["stellarity.spirit_dagger.aec","smithed.entity","smithed.strict"],custom_particle:{type:"block","block_state":"air"}}
execute as @n[type=area_effect_cloud,tag=stellarity.spirit_dagger.aec] at @s run function stellarity:item/spirit_dagger/spirit/as_aec
