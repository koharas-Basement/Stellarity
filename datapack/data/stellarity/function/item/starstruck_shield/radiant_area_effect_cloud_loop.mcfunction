...
# Don't ask my why, it was easier to do it that way
  execute store result score @s[scores={stellarity.misc=1}] stellarity.misc2 run random value 1..5

# Summon stars
  execute \
  if score @s stellarity.misc2 matches 1..5 \
  if score @s stellarity.misc matches 1 \
  run function stellarity:item/starstruck_shield/summon_star

execute \
if score @s stellarity.misc2 matches 1..4 \
if score @s stellarity.misc matches 3 \
run function stellarity:item/starstruck_shield/summon_star
...
if score @s stellarity.misc matches 7 \
run function stellarity:item/starstruck_shield/summon_star
