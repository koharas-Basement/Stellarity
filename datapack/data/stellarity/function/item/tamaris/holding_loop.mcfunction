...
execute if score @s[tag=!stellarity.item.tamaris.no_warn] stellarity.item.tamaris.execute_cooldown matches 1.. run title @s actionbar {"translate":"stellarity.item.weapons.tamaris.disabled","color":"red"}
