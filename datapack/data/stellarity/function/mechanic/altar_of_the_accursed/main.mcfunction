...
execute positioned ~ ~-1 ~ as @n[type=item_display,distance=..1,tag=stellarity.altar_of_the_accursed_display] run function stellarity:mechanic/altar_of_the_accursed/loop/item_display