...
execute at @p run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["stellarity.bless","smithed.entity","smithed.strict"],potion_contents:{custom_effects:[{id:"minecraft:haste",duration:1,show_particles:1b,show_icon:1b,ambient:1b}]},Duration:2,ReapplicationDelay:0,WaitTime:-1,Age:-1}
