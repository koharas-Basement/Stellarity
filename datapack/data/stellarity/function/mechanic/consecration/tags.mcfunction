...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:red_poplar_leaves"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.leaves"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:orange_poplar_leaves"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.leaves"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:yellow_poplar_leaves"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.leaves"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:poplar_sapling"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sapling"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:pointed_dripstone"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.pointed_dripstone"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:poplar_log"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.logs"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stripped_poplar_log"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stripped_logs"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:poplar_wood"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.woods"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stripped_poplar_wood"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stripped_woods"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stone_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stone_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stone_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stone_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stone_bricks"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stone_bricks"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stone_brick_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stone_brick_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stone_brick_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stone_brick_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:stone_brick_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.stone_brick_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobblestone"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobblestone"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobblestone_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobblestone_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobblestone_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobblestone_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobblestone_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobblestone_wall"
...
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:deepslate_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.deepslate_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:deepslate_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.deepslate_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:deepslate_bricks"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.deepslate_bricks"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:deepslate_brick_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.deepslate_brick_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:deepslate_brick_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.deepslate_brick_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:deepslate_brick_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.deepslate_brick_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobbled_deepslate"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobbled_deepslate"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobbled_deepslate_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobbled_deepslate_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobbled_deepslate_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobbled_deepslate_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cobbled_deepslate_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cobbled_deepslate_wall"

execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_sulfur"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_sulfur"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_sulfur_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_sulfur_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_sulfur_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_sulfur_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_sulfur_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_sulfur_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_bricks"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_bricks"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_brick_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_brick_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_brick_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_brick_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_brick_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_brick_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:chiseled_sulfur"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.chiseled_sulfur"

execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:sulfur_spike"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.sulfur_spike"

execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_cinnabar"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_cinnabar"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_cinnabar_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_cinnabar_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_cinnabar_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_cinnabar_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:polished_cinnabar_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.polished_cinnabar_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar_bricks"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar_bricks"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar_brick_slab"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar_brick_slab"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar_brick_stairs"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar_brick_stairs"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:cinnabar_brick_wall"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.cinnabar_brick_wall"
execute if data storage stellarity:temp {consecration:{nbt:{id:"minecraft:chiseled_cinnabar"}}} run data modify storage stellarity:temp consecration.item_tag set value "stellarity.consecration.chiseled_cinnabar"
