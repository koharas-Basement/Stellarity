...
scoreboard players set @s stellarity.items.elytra.damage 0
execute store result score @s stellarity.items.elytra.damage run data get entity @s equipment.chest.components."minecraft:damage" 1
...
scoreboard players operation @s stellarity.items.elytra.damage += #temp stellarity.misc
execute if score @s stellarity.items.elytra.damage matches 431.. run scoreboard players set @s stellarity.items.elytra.damage 430

execute store result storage stellarity:temp elytra_nerf.damage int 1 run scoreboard players get @s stellarity.items.elytra.damage
