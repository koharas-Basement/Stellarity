...
execute if entity @n[type=minecraft:interaction,tag=stellarity.pixie_in_a_jar_light_radiant_interaction,distance=..0.5] run data modify storage stellarity:temp pixie_in_a_jar.color set value radiant
