...
$execute align xyz positioned ~.5 ~.5 ~.5 run summon interaction ~ ~-0.5 ~ {Tags:["stellarity.pixie_in_a_jar_interaction","stellarity.pixie_in_a_jar_$(color)_interaction","stellarity.interaction","smithed.entity","smithed.strict"]}
