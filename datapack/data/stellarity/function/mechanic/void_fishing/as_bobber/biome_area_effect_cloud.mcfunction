...
data merge entity @s {Radius:0,Tags:["stellarity.void_fishing.area_effect_cloud","stellarity.area_effect_cloud"],Duration:2147483647,custom_particle:{type:"block",block_state:"air"}}
