...
## Useful Links
  ...
  {"text":"Discord","color":"#589CF2","bold":false,"click_event": {"action": "open_url","url": "https://discord.com/invite/5u3TTVmkSq"},"hover_event": {"action": "show_text","value":{"text":"Click to visit"}}},\
  {"text": " ▪ ","color":"gray","bold":true},\
