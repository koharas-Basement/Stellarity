...
## Useful Links
  ...
  {"text":"Wiki","color":"#FBA957","bold":false,"click_event": {"action": "open_url","url": "https://prismaticshards.wiki.gg/wiki/Stellarity"},"hover_event": {"action": "show_text","value":{"text":"Click to visit"}}},\
  {"text": " ▪ ","color":"gray","bold":true},\
