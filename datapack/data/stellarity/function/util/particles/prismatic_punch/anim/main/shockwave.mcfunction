...
execute if score @s stellarity.misc matches 9 run data modify entity @s item.components."minecraft:custom_model_data".floats[0] set value 9f
execute if score @s stellarity.misc matches 10 run data modify entity @s item.components."minecraft:custom_model_data".floats[0] set value 10f
execute if score @s stellarity.misc matches 11 run data modify entity @s item.components."minecraft:custom_model_data".floats[0] set value 11f

execute if score @s stellarity.misc matches 12 run kill @s
