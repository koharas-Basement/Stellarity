...
execute if score @s stellarity.misc matches ..99 run particle block{block_state:{id:"cherry_leaves"}} ^ ^.7 ^ 0.35 0.35 0.35 1 3
execute if score @s stellarity.misc matches 100..199 run particle block{block_state:{id:"cherry_leaves"}} ^ ^.7 ^ 0.4 0.4 0.4 1 6
execute if score @s stellarity.misc matches 200..299 run particle block{block_state:{id:"cherry_leaves"}} ^ ^.7 ^ 0.45 0.45 0.45 1 9
execute if score @s stellarity.misc matches 300..399 run particle block{block_state:{id:"cherry_leaves"}} ^ ^.7 ^ 0.5 0.5 0.5 1 12
execute if score @s stellarity.misc matches 400..499 run particle block{block_state:{id:"cherry_leaves"}} ^ ^.7 ^ 0.55 0.55 0.55 1 15
execute if score @s stellarity.misc matches 500.. run particle block{block_state:{id:"cherry_leaves"}} ^ ^.7 ^ 0.6 0.6 0.6 1 18
