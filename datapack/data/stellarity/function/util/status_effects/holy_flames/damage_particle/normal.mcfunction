...
execute if score @s stellarity.dot.holy_flames.particle_cycle matches 4 run \
	particle minecraft:dust{color:[0.6, 0.98, 0.243], scale:1.6} ~ ~1 ~ .4 .55 .4 0 16 force @a[distance=..32]
execute if score @s stellarity.dot.holy_flames.particle_cycle matches 5 run \
	particle minecraft:dust{color:[0.243, 0.894, 0.98], scale:1.6} ~ ~1 ~ .4 .55 .4 0 16 force @a[distance=..32]
execute if score @s stellarity.dot.holy_flames.particle_cycle matches 6 run \
	particle minecraft:dust{color:[0.318, 0.243, 0.98], scale:1.6} ~ ~1 ~ .4 .55 .4 0 16 force @a[distance=..32]
execute if score @s stellarity.dot.holy_flames.particle_cycle matches 7 run \
	particle minecraft:dust{color:[0.98, 0.243, 0.918], scale:1.6} ~ ~1 ~ .4 .55 .4 0 16 force @a[distance=..32]
execute if score @s stellarity.dot.holy_flames.particle_cycle matches 8 run \
	particle minecraft:dust{color:[0.647, 0.243, 0.98], scale:1.6} ~ ~1 ~ .4 .55 .4 0 16 force @a[distance=..32]

scoreboard players reset @s[scores={stellarity.dot.holy_flames.particle_cycle=8}] stellarity.dot.holy_flames.particle_cycle
