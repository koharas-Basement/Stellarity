...
execute if score #StringLib.SuccessCheck StringLib matches 0 if score #StringLib.FindLength StringLib matches 2.. if function stellarity:util/stringlib/zprivate/find/check_word_rest store result storage stringlib:output find[-1] int 1 run return run scoreboard players remove #StringLib.Index StringLib 1
...
function stellarity:util/stringlib/zprivate/find/check_word_start_loop
